            ...
            <table className="min-w-full divide-y divide-gray-300">
              ...
              {customers.map((customer) => (
                <tr key={customer.email}>
                  <td className="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
                    <div className="flex items-center">
                      <div className="h-11 w-11 flex-shrink-0">
                        <img alt="" src={customer.image} className="h-11 w-11 rounded-full" />
                      </div>
                      <div className="ml-4">
                  ...
                  <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                    <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">{customer.birthday}</td>
                  </td>
                  <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                    <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">{customer.phone}</td>
                  </td>
